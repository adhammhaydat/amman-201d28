...
three numbers as separate arguments and returns an array 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  let total1 = a + b + c;
  let total2 = a * b * c;
  return [total1, `The sum of ${a} and ${b} and ${c} is ${total}.`, total2, `The product of ${a} and ${b} and ${c} is ${total}.`, total1, `Third element: ${a} and ${b} and ${a} sum to ${total1}`,
    total2, `Fourth element: "The product of ${a} and ${b} and ${c} is ${total2}.`];
}
